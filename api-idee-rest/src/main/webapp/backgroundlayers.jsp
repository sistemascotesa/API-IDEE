            ...
            <body>
                <div class="m-api-idee-test-form-frame">
                    <div class="m-test-form" style="max-height: 8rem;">
                        ...
                        <div>
                            <label for="inputLayerIndex" title="Preactivar capa con el índice seleccionado">Índice de
                                capa "layerIndex"</label>
                            <input type="number" name="inputLayer" id="inputLayerIndex" value="0" min="0" max="10">
                        </div>
                        <div>
                            <label for="selectVisible">Visible al inicio "visible"</label>
                            <select name="visible" id="selectVisible">
