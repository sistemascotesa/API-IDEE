        ...
        <%@ page import="java.util.Map" %>
            ...
            <body>
                ...
                <div>
                    ...
                    <input type="text" name="urlAttribute" id="inputURLAttribute" list="urlattributeSug"
                        value="Gobierno de España">
                    ...
                    <input type="text" name="defaultAttribution" id="inputDefaultAttribution"
                        list="defaultAttributionSug" value="Instituto Geográfico Nacional">
                    ...
                    <div id="divModo">
                        ...
                        <input type="text" name="url" id="inputUrl" list="urlSug"
                            value="${api-idee.static_resources.url}/Datos/reconocimientos/WMTS_PNOA_20170220/atribucionPNOA_Url.kml">
                        <datalist id="urlSug">
                            <option
                                value="${api-idee.static_resources.url}/Datos/reconocimientos/WMTS_PNOA_20170220/atribucionPNOA_Url.kml">
                            </option>
