/**
 * @module IDEE/impl/control/ModifyFeature
 */
export default class ModifyFeature extends IDEE.impl.Control {
  /**
   * @classdesc
   ...
   */
  activate() {
    if (IDEE.utils.isNullOrEmpty(this.modify)) {
  ...
  createInteractionModify_() {
    ...
    if (olStrokeClone != null) {
      olStrokeClone.setColor(IDEE.utils.getRgba(olStroke.getColor()));
    }
    if (styleImage == null) {
